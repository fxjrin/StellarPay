...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CC6THIWIYPXPQEZJ7WJSBD4DNG4HBALIVKDF53E3GS46BYFFIHUH34QV";
    };
};
...
export interface Client {
     ...
     */
    create_payment: ({ sender, recipient_username, token, amount, message }: {
        sender: string;
        recipient_username: string;
        token: string;
        amount: i128;
     ...
     */
    get_payment_id_at: ({ username, index }: {
        username: string;
        index: u64;
    }, options?: {
        /**
     ...
     * Claim payment
     */
    claim_payment: ({ recipient, payment_id }: {
        recipient: string;
        payment_id: u64;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        create_payment: (json: string) => AssembledTransaction<bigint>;
        get_payment_count: (json: string) => AssembledTransaction<bigint>;
        get_payment_id_at: (json: string) => AssembledTransaction<Option<bigint>>;
        claim_payment: (json: string) => AssembledTransaction<null>;
        get_payment: (json: string) => AssembledTransaction<Option<Payment>>;
    };
}
